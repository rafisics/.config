...
<state_management>
  <reads>
    - specs/literature/ (PDF, DJVU, and markdown files)
    - specs/literature/index.json (current index state)
  </reads>

  <writes>
    - specs/literature/*.md (new markdown conversions)
    - specs/literature/index.json (index entries)
    - specs/literature/*/index.json (subdirectory indexes for chunked documents)
  </writes>
</state_management>
